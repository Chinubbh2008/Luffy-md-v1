...
const sms = (conn, m) => {
  ...
  if (m.message) {
    ...
    if (m.msg) {
      ...
      var quotedMention =
        m.msg.contextInfo != null ? m.msg.contextInfo.participant : "";
      var tagMention =
        m.msg.contextInfo != null ? m.msg.contextInfo.mentionedJid : [];
      ...
      m.body =
        m.type === "conversation"
          ...
          : "";
      m.quoted =
        m.msg.contextInfo != undefined ? m.msg.contextInfo.quotedMessage : null;
      if (m.quoted) {
        ...
        var quoted_quotedMention =
          m.quoted.msg.contextInfo != null
            ? m.quoted.msg.contextInfo.participant
            : "";
        var quoted_tagMention =
          m.quoted.msg.contextInfo != null
            ? m.quoted.msg.contextInfo.mentionedJid
            : [];
        var quoted_mention =
          typeof quoted_tagMention == "string"
            ? [quoted_tagMention]
            : quoted_tagMention;
        quoted_mention != undefined
          ? quoted_mention.push(quoted_quotedMention)
          : [];
        m.quoted.mentionUser =
          quoted_mention != undefined ? quoted_mention.filter((x) => x) : [];
        ...
        m.quoted.download = (filename) =>
          downloadMediaMessage(m.quoted, filename);
        m.quoted.delete = () =>
  ...
  m.reply = (teks, id = m.chat, option = { mentions: [m.sender] }) =>
    conn.sendMessage(
      id,
      { text: teks, contextInfo: { mentionedJid: option.mentions } },
      { quoted: m }
    );
  m.replyS = (stik, id = m.chat, option = { mentions: [m.sender] }) =>
    conn.sendMessage(
      id,
      { sticker: stik, contextInfo: { mentionedJid: option.mentions } },
      { quoted: m }
    );
  ...
  m.replyVid = (
    ...
    teks,
    id = m.chat,
    option = { mentions: [m.sender], gif: false }
  ) =>
    conn.sendMessage(
      id,
      {
  ...
  m.replyAud = (
    aud,
    id = m.chat,
    option = { mentions: [m.sender], ptt: false }
  ) =>
    conn.sendMessage(
      id,
      {
